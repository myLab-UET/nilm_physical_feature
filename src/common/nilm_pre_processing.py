...
class NilmPreProcessing:
    ...
    def plot_data_with_time(self, df: pd.DataFrame, device_name:str, start:int = None, end:int = None, which_plot: dict = None):
        input_df = None
        ...
        if which_plot is None:
            ...
            self.__plot_data(input_df=input_df, which_plot=which_plot)
